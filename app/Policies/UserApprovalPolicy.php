...
class UserApprovalPolicy
{
    ...
    {
        return $user->can('delete_user::approval');
    }
    ...
    {
        return $user->can('delete_any_user::approval');
    }
    ...
    {
        return $user->can('force_delete_user::approval');
    }
    ...
    {
        return $user->can('force_delete_any_user::approval');
    }
    ...
    {
        return $user->can('restore_user::approval');
    }
    ...
    {
        return $user->can('restore_any_user::approval');
    }
    ...
    {
        return $user->can('replicate_user::approval');
    }
    ...
    {
        return $user->can('reorder_user::approval');
    }
}
